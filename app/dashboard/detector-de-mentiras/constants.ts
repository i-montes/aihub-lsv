...
/**
 * Schema de Zod para una transcripción de video de YouTube
 */
export const youtubeTranscriptSchema = z.object({
  /** Identificador local del item en el formulario */
  id: z.string(),
  ...
  /** Información del video + transcripción, tal como se inyecta en el prompt */
  text: z.string().default(""),
  /** true si se obtuvieron los subtítulos reales del video */
...
/**
 * Tipo de una transcripción dentro del formulario
 */
export type YoutubeTranscriptItem = z.infer<typeof youtubeTranscriptSchema>;
...
export const formSchema = z.object({
  ...
  additional_context: z.object({
    ...
    metadata: metadataSchema.optional(),
    transcripts: z
      .array(youtubeTranscriptSchema)
      .default([])
      .describe("Transcripciones de videos de YouTube adjuntadas al contexto"),
  }),
