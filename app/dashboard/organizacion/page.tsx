...
import { Building, Users, User, Shield, Edit, Info, AlertTriangle } from "lucide-react"
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <p className="text-gray-500">
          Manage your organization details and members. This demonstrates how RLS policies control access to
          organization data.
        </p>
        ...
        {!organization ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <h2 className="text-xl font-medium text-gray-700 mb-2">No Organization</h2>
              <p className="text-gray-500 text-center max-w-md mb-6">
                You are not part of any organization. Create one to collaborate with team members.
              </p>
              <Button
                  ...
                  {editing ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="mt-1">{organization.address || "No address provided"}</p>
                      </div>

                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                          <h3 className="text-sm font-medium text-gray-500">City</h3>
                          <p className="mt-1">{organization.city || "No city provided"}</p>
                        </div>

                        <div>
                          <h3 className="text-sm font-medium text-gray-500">Country</h3>
                          <p className="mt-1">{organization.country || "No country provided"}</p>
                        </div>
                      </div>
                        ...
                        <div key={member.id} className="flex items-center gap-3">
                          ...
                          {member.role && (
                            <div className="flex items-center gap-1 px-2 py-1 bg-gray-100 rounded-full">
                              {member.role === "OWNER" && <Shield className="h-3 w-3 text-primary-600" />}
                ...
                <Card className="mt-6">
                  ...
                  <CardContent>
                    <Button
                      variant="destructive"
                      className="w-full"
                      onClick={() => toast.info("Organization deletion coming soon")}
                    >
                      Delete Organization
                    </Button>
                  </CardContent>
