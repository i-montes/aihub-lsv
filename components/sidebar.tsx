...
import { Home, BarChart, FileCheck, FileText, ChevronRight, ChevronLeft } from "lucide-react"
...
export function Sidebar() {
  ...
  return (
    <div className={`h-full py-4 sm:py-6 transition-all duration-300 ml-2 ${isExpanded ? "w-[200px]" : "w-[70px]"}`}>
      <div className="flex flex-col h-full bg-white rounded-3xl shadow-sm py-4 px-2 relative">
        {/* Logo del dashboard */}
